defmodule Day11Test do
  ...
  test "day 11 parsing works for sample input", context do
    input_string = ~s"125 17"
    expected_input = {[125, 17], 25, 75}
  ...
  test "day 11 part 1 works for sample input", context do
    input_string = ~s"125 17"
  ...
  test "day 11 part 1 works for real input", context do
    input_string = InputReader.read_day_input(context[:day])
    expected_result = "203953"
  ...
  test "day 11 part 2 works for sample input", context do
    input_string = ~s"125 17"
    expected_result = "55312"

    solver = AdventOfCode2024.day_solver(context[:day])
    {stones, _, _} = DaySolver.parse_input(solver, input_string)
    input = {stones, 25, 25} # Special change because there is no actual test example
  ...
  @tag timeout: :infinity
  test "day 11 part 2 works for real input", context do
    input_string = InputReader.read_day_input(context[:day])
    expected_result = "242090118578155"
