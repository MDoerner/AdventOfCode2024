defmodule Day15Test do
  ...
  test "day 15 parsing works for sample input", context do
    input_string = ~s""
  ...
  test "day 15 part 1 works for sample input", context do
    input_string = ~s""
    expected_result = "42"
  ...
  test "day 15 part 2 works for sample input", context do
    input_string = ~s""
    expected_result = "42"
